...
('RT @davidmoadel: $SPY The Impossible Stealth Bull Market https://t.co/BaCvapncSM $SPX $DIA $QQQ $IWM $AAPL $GOOG $GOOGL $AMZN $NFLX $FB $TS', 'SPAM'),
('$SPY The Impossible Stealth Bull Market https://t.co/BaCvapncSM $SPX $DIA $QQQ $IWM $AAPL $GOOG $GOOGL $AMZN $NFLX $FB $TSLA $TWTR', 'SPAM'),
('$BAC $GOOG $DWTI #pennystocks', 'SPAM'),
('Get free access to my trading resources library #stocks #trading $AAPL $NFLX $TSLA $GOOGL  https://t.co/ip995RHaSC https://t.co/iaMYcTM1Gg', 'SPAM'),
('RT @InvestorHangout: We are LIVE Covering:', 'SPAM'),
('Are you Bullish or Bearish on #Snapchat? Start #Trading $SNAP with #Bitcoin. 15:1 Leverage. #Stocks #Fintech #BTC… https://t.co/mAnr3lus67', 'SPAM'),
('Trade with the best indicators', 'SPAM'),
('', 'SPAM'),
('', 'SPAM'),
('', 'SPAM'),
('', 'SPAM'),
...
('How To Advertise On Google And Get Great Results - Huffington Post https://t.co/mPAfmh4kgs #Google $GOOG $GOOGL https://t.co/HrEbB8zuU1', 'NON-SPAM'),
('RT SeekingAlpha: https://t.co/U1r1iPbcW2 Daily Round Up 7/1/16: AXDX, OPK, IMH, SCYX https://t.co/aVF943G1rw $ADBE $CLGX $EXR $GOOG $IMH', 'NON-SPAM'),
('Frontier Lines Up Against Google Fiber in AT&amp;T Fight Over Utility Pole Access https://t.co/HOeUy8nK1t $GOOG', 'NON-SPAM'),
('Scrutiny of Google #Tax liabilities intensifies with Spanish raid $GOOG #Technology #Share #GlobalNews https://t.co/2HZyKeKcHV', 'NON-SPAM'),
('RT @mdudas: The duopoly that rules online ads, $FB + $GOOG, is eliminating distinctions btw 1st &amp; 3rd party data ~ @profcarroll', 'NON-SPAM'),
('RT @racernic: $AAPL vs. $GOOGl $AMZN today''s action. if you chased aapl down on open u lost money. here is what hapnd https://t.co/21jIk3NG', 'NON-SPAM'),
('Alphabet’s $GOOG “Underperform” Rating Reiterated at Wedbush https://t.co/teAjzFznhA', 'NON-SPAM'),
('Alphabet Inc $GOOG Given Underperform Rating at Wedbush https://t.co/fkXyi21ql5', 'NON-SPAM'),
('$GOOG received a new alert. Find out why at https://t.co/nZwqReM0tj #stocks #daytrading #trading #mkt  #NYSE #NASDAQ #markets 161', 'NON-SPAM'),
('#Nvidia is a lot bigger than #selfdrivingcars #MedicalImages #mri #xray #Google #ibm $GOOGL $GOOG $IBM $NVDA #CANCER https://t.co/NIVP4Wti1D', 'NON-SPAM'),
('$GOOG Google&amp;apos;s head of Pixel smartphone division leaves after six months https://t.co/o4MCCFTAIB', 'NON-SPAM'),
('RT @mcwm: Google is up big on another kickass earnings report', 'NON-SPAM'),
('These are the companies investing most aggressively in #AR and #VR https://t.co/Wfa7lDEAZ5 $INTC $QCOM $FB $GOOGL $CMCSA', 'NON-SPAM'),
('Snapchat may need to switch to an algorithmic feed to increase user growth... via @JoshConstine | $SNAP $FB #Tech https://t.co/hTrdDvk9CG', 'NON-SPAM'),
('Will be taking some of my $twtr gains over to $snap calls end of the week.  I see snap going much higher.', 'NON-SPAM'),
('Twitter''s First Quarter Was Good. Instagram''s Was Better. @themotleyfool #stocks $FB, $TWTR, $SNAP https://t.co/ere1E2x9AT', 'NON-SPAM'),
('Yo follow the StockTwits Snapchat right now it''s just getting started. Tha takeover $SNAP', 'NON-SPAM'),
('If You Think Netflix, Amazon Disrupted Hollywood, You''ll Love $Snap https://t.co/LN6QgkRWb1', 'NON-SPAM'),
('When 2 personalities with the same fire and passion meet, they create $GOOG $SNAP ....; create #BetterLiving', 'NON-SPAM'),
('$SNAP people still buying the hype when they shouldn''t  https://t.co/J9O4we5wBJ  $FB', 'NON-SPAM'),
('', 'NON-SPAM'),
('', 'NON-SPAM'),
('', 'NON-SPAM'),
('', 'NON-SPAM'),
